...
#error Unknown USE_BPP
	...
	//HAL& hal = touchgfx_generic_init<STM32F7HAL>(dma, display, tc, 480, 480, (uint16_t*)bmpCache, 232000, 1);
	HAL& hal = touchgfx_generic_init<HALSDL2>(dma, lcd, tc, SIM_WIDTH, SIM_HEIGHT, (uint16_t*)IMAGE_BUFFER, sizeof(IMAGE_BUFFER),4);
